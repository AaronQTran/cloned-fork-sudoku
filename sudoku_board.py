...
class Board:
    ...
    def sketch(self, value, row, col):
        ...
        if self.cell_board[row][col].sketched_value == 0:
            ...
            # Inserts sketch value to get rid of old one and recalls the function
            font = pygame.font.SysFont('arial', 30)
    ...
    def check_board(self):
        # Checks if the board is a winner or loser
        self.update_board()
